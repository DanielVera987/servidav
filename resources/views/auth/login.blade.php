...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
            <div class="card card-login my-5 rounded-lg">
                <h2 class="my-4 text-center"><strong>Hey que onda!,<br/> iniciemos sesión</strong></h2>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-12">
                                <button style="background-color: #8FBDD9;border-color: #8FBDD9;" type="submit" class="btn btn-primary btn-md btn-block">
                                    {{ __('Empezar') }}
                                </button>
                                {{-- 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <a class="btn-block btn btn-link text-secondary text-center" href="{{ route('register') }}">
                                    {{ __('Registrarse') }}
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            <button class="btn btn-md btn-light btn-block border border-dark">
...
@section('footer')
    <footer class="footer text-center py-3">
        <div class="container">
        <div class="text-light font-weight-lighter">Hecho con 
